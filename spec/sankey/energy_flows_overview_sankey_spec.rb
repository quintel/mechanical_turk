  ...
  Turk::PresetCollection.from_keys(:ii3050, :nvdt, :scenario_collection, :merit_off).each do |scenario|
    ...
    context "with scenario #{scenario.original_scenario_id}" do
      ...
      it 'Primary demand of electricity should match the sum of electricity primary demand flows in the data-export' do
        skip ('Excess electricity is included in nodes but not in flows, see quintel/mechanical_turk#148')
        expect(
      ...
      # TODO add test to generic_groups_spec to verify if all primary demand nodes are present in the defined flows
