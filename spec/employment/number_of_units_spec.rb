...
describe "Demand > Households > Space Heating" do
  ...
  context "Testing if 0 < full_load_hours < 8760 (hours in a year)" do
    ...
    it " full_load_hours of households_space_heater_hybrid_heatpump_air_water_electricity should be within 4380.0 of 4380.0" do
      @scenario.households_space_heater_hybrid_heatpump_air_water_electricity_share = 100 #%
      expect(@scenario.turk_full_load_hours_of_households_space_heater_hybrid_heatpump_air_water_electricity.value).to be_within(4380.0).of(4380.0)
    end
    ...
    it " full_load_hours of households_water_heater_network_gas should be within 4380.0 of 4380.0" do
      @scenario.households_heater_network_gas_share = 100 #%
    ...
    it " full_load_hours of households_water_heater_hybrid_heatpump_air_water_electricity should be within 4380.0 of 4380.0" do
      @scenario.households_heater_hybrid_heatpump_air_water_electricity_share = 100 #%
      expect(@scenario.turk_full_load_hours_of_households_water_heater_hybrid_heatpump_air_water_electricity.value).to be_within(4380.0).of(4380.0)
    end
  end
  ...
  context "Testing if number_of_units == 7587964.0 (#households)" do
    ...
    it " number_of_units of households_space_heater_electricity should be within 10.0 of 7587964.0" do
      @scenario.households_heater_electricity_share = 100 #%
    ...
    it " number_of_units of households_space_heater_micro_chp_network_gas should be within 10.0 of 3724649.0" do
      @scenario.households_heater_micro_chp_network_gas_share = 50 #%
