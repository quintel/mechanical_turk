# Tests if supply and demand in mekko match
# For some mekkos, it also tests if total supply and demand in mekko
# match total carrier supply and demand

require 'spec_helper'

RSpec.describe 'Mekko balancing' do
  Turk::PresetCollection.from_keys(:ii3050v2, :kev).each do |scenario|
