...
describe "Testing costs" do
  ...
  context "Testing all converters with total cost" do
    ...
    it "total cost of agriculture_chp_engine_biogas should be within 5.0% of 698724.9" do
      @scenario.total_cost_of_agriculture_chp_engine_biogas.value.should be_within(34936).of(698724.9)
    end
    ...
    it "total cost of energy_chp_ultra_supercritical_cofiring_coal should be within 5.0% of 358349929" do
      @scenario.total_cost_of_energy_chp_ultra_supercritical_cofiring_coal.value.should be_within(17917496).of(358349929)
    end
    ...
    it "total cost of energy_power_ultra_supercritical_cofiring_coal should be within 5.0% of 344201361" do
      @scenario.total_cost_of_energy_power_ultra_supercritical_cofiring_coal.value.should be_within(17210068).of(344201361)
    end
    ...
    it "total cost of industry_chp_ultra_supercritical_coal should be within 5.0% of 5711230.1" do
      @scenario.total_cost_of_industry_chp_ultra_supercritical_coal.value.should be_within(285561).of(5711230.1)
    end
