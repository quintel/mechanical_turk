...
describe "Testing costs" do
  ...
  context "Testing all converters with total cost" do
    ...
    it "total cost of agriculture_chp_engine_network_gas should be within 5.0% of 684410.007" do
      @scenario.total_cost_of_agriculture_chp_engine_network_gas.value.should be_within(34220.50035).of(684410.007)
    end
    ...
    it "total cost of buildings_collective_chp_network_gas should be within 5.0% of 728323.8009" do
      @scenario.total_cost_of_buildings_collective_chp_network_gas.value.should be_within(36416.190045).of(728323.8009)
    end
    ...
    it "total cost of households_collective_chp_network_gas should be within 5.0% of 728323.8009" do
      @scenario.total_cost_of_households_collective_chp_network_gas.value.should be_within(36416.190045).of(728323.8009)
    end
    ...
    it "total cost of buildings_collective_chp_wood_pellets should be within 5.0% of 2280121.059" do
      @scenario.total_cost_of_buildings_collective_chp_wood_pellets.value.should be_within(114006.05295).of(2280121.059)
    end
    ...
    it "total cost of households_collective_chp_wood_pellets should be within 5.0% of 2280121.059" do
      @scenario.total_cost_of_households_collective_chp_wood_pellets.value.should be_within(114006.05295).of(2280121.059)
    end
    ...
    it "total cost of agriculture_chp_supercritical_wood_pellets should be within 5.0% of 2920458.22" do
      @scenario.total_cost_of_agriculture_chp_supercritical_wood_pellets.value.should be_within(146022.91100000002).of(2920458.22)
    end
    ...
    it "total cost of energy_heater_for_heat_network_crude_oil should be within 5.0% of 14724400.45" do
      @scenario.total_cost_of_energy_heater_for_heat_network_crude_oil.value.should be_within(736220.0225).of(14724400.45)
    end
    ...
    it "total cost of energy_power_turbine_network_gas should be within 5.0% of 17417062.28" do
      @scenario.total_cost_of_energy_power_turbine_network_gas.value.should be_within(870853.1140000001).of(17417062.28)
    end

    it "total cost of energy_power_supercritical_waste_mix should be within 5.0% of 27648900.0" do
      @scenario.total_cost_of_energy_power_supercritical_waste_mix.value.should be_within(1382445.0).of(27648900.0)
    end

    it "total cost of industry_chp_turbine_gas_power_fuelmix should be within 5.0% of 33166602.27" do
      @scenario.total_cost_of_industry_chp_turbine_gas_power_fuelmix.value.should be_within(1658330.1135).of(33166602.27)
    end
    ...
    it "total cost of energy_chp_combined_cycle_network_gas should be within 5.0% of 57135195.93" do
      @scenario.total_cost_of_energy_chp_combined_cycle_network_gas.value.should be_within(2856759.7965).of(57135195.93)
    end
    ...
    it "total cost of industry_chp_combined_cycle_gas_power_fuelmix should be within 5.0% of 67549434.66" do
      @scenario.total_cost_of_industry_chp_combined_cycle_gas_power_fuelmix.value.should be_within(3377471.733).of(67549434.66)
    end
    ...
    it "total cost of energy_power_ultra_supercritical_network_gas should be within 5.0% of 104285238.7" do
      @scenario.total_cost_of_energy_power_ultra_supercritical_network_gas.value.should be_within(5214261.9350000005).of(104285238.7)
    end
    ...
    it "total cost of energy_power_supercritical_coal should be within 5.0% of 176157457.4" do
      @scenario.total_cost_of_energy_power_supercritical_coal.value.should be_within(8807872.870000001).of(176157457.4)
    end
    ...
    it "total cost of energy_power_ultra_supercritical_coal should be within 5.0% of 230600996.2" do
      @scenario.total_cost_of_energy_power_ultra_supercritical_coal.value.should be_within(11530049.81).of(230600996.2)
    end

    it "total cost of energy_power_combined_cycle_network_gas should be within 5.0% of 260295067.1" do
      @scenario.total_cost_of_energy_power_combined_cycle_network_gas.value.should be_within(13014753.355).of(260295067.1)
    end

    it "total cost of energy_chp_ultra_supercritical_coal should be within 5.0% of 260609607.4" do
      @scenario.total_cost_of_energy_chp_ultra_supercritical_coal.value.should be_within(13030480.370000001).of(260609607.4)
    end
    ...
    it "total cost of energy_power_ultra_supercritical_ccs_coal should be within 5.0% of 260840943.6" do
      @scenario.total_cost_of_energy_power_ultra_supercritical_ccs_coal.value.should be_within(13042047.18).of(260840943.6)
    end

    it "total cost of energy_power_combined_cycle_ccs_network_gas should be within 5.0% of 263181591.9" do
      @scenario.total_cost_of_energy_power_combined_cycle_ccs_network_gas.value.should be_within(13159079.595).of(263181591.9)
    end

    it "total cost of energy_power_combined_cycle_ccs_coal should be within 5.0% of 281120213.2" do
      @scenario.total_cost_of_energy_power_combined_cycle_ccs_coal.value.should be_within(14056010.66).of(281120213.2)
    end
    ...
    it "total cost of energy_power_ultra_supercritical_cofiring_coal should be within 5.0% of 344201361.3" do
      @scenario.total_cost_of_energy_power_ultra_supercritical_cofiring_coal.value.should be_within(17210068.065).of(344201361.3)
    end

    it "total cost of energy_chp_ultra_supercritical_cofiring_coal should be within 5.0% of 358349929.1" do
      @scenario.total_cost_of_energy_chp_ultra_supercritical_cofiring_coal.value.should be_within(17917496.455000002).of(358349929.1)
    end
