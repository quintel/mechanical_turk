it "total cost of ﻿key should be within 5.0% of 0.0" do
...
it "total cost of transport_car_using_electricity should be within 5.0% of 0.0" do
    @scenario.total_cost_of_transport_car_using_electricity.value.should be_within(0.0).of(0.0)
end
it "total cost of transport_car_using_hydrogen should be within 5.0% of 0.0" do
    @scenario.total_cost_of_transport_car_using_hydrogen.value.should be_within(0.0).of(0.0)
end
it "total cost of transport_truck_using_hydrogen should be within 5.0% of 0.0" do
