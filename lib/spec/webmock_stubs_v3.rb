...
WebMock.stub_request(:put, Turk::Connection.base_uri + "/1.json?reset=true&scenario[user_values][250]=10&gqueries[]=foo&source=Mechanical%20Turk"). \
  to_return( :status => 200,
             :body => {
               "gqueries" => {
...
WebMock.stub_request(:put, Turk::Connection.base_uri + "/1.json?gqueries%5B0%5D=foo&reset=true&scenario%5Buser_values%5D%5B0%5D=10&scenario%5Buser_values%5D%5B1%5D=11&source=Mechanical%20Turk"). \
  to_return( :status => 200,
             :body => {
               "gqueries" => {
                 "foo" => {"present" => 1, "future" => 2, "unit" => "gold"}
